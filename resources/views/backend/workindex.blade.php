    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
         ...
         <a class='col-lg-offset-5 btn btn-success' href="{{ route('work.create') }}">Add New</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="card-body"  id="tableWrapper">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$work->country}}</td>
                    <td>
                    <a class='col-lg-offset-5 btn btn-warning' href="{{ route('workedit', ['id'=>encrypt($work->id)])}}">Edit</a>
                    <a class='col-lg-offset-5 btn btn-danger' href="{{ route('workdelete', ['id'=>encrypt($work->id)])}}">Delete</a>    
                    </td>
                  </tr>
                  @endforeach
